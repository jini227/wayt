...
export function shouldStartDownwardDismissDrag(gesture: DismissDragGesture) {
  return isDownwardVerticalDrag(gesture) && gesture.dy >= START_DISTANCE;
}

export function shouldCompleteDownwardDismissDrag(gesture: DismissDragGesture) {
...
function isDownwardVerticalDrag(gesture: DismissDragGesture) {
